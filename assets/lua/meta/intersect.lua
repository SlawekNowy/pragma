...
--- @overload fun(rayStart: vector.Vector, rayDir: vector.Vector, mesh: game.Model.Mesh, r0: any, r1: any): 
--- @overload fun(rayStart: vector.Vector, rayDir: vector.Vector, mesh: game.Model.Mesh, r0: any, r1: any, precise: bool): 
--- @overload fun(rayStart: vector.Vector, rayDir: vector.Vector, mesh: game.Model.Mesh, r0: any, r1: any, precise: bool, meshPose: math.Transform): 
--- @overload fun(rayStart: vector.Vector, rayDir: vector.Vector, mesh: game.Model.Mesh.Sub, r0: any, r1: any): 
--- @overload fun(rayStart: vector.Vector, rayDir: vector.Vector, mesh: game.Model.Mesh.Sub, r0: any, r1: any, precise: bool): 
--- @overload fun(rayStart: vector.Vector, rayDir: vector.Vector, mesh: game.Model.Mesh.Sub, r0: any, r1: any, precise: bool, meshPose: math.Transform): 
