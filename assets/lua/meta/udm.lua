...
--- @return any ret0
function udm.get_default_value(type) end

--- 
--- @param ov0 struct luabind::adl::udm_type<class luabind::adl::object,1,1,0>
--- @param ov1 struct luabind::adl::udm_type<class luabind::adl::object,1,1,0>
--- @param type enum udm::Type
--- @return bool ret0
--- @overload fun(ov0: struct luabind::adl::udm_type<class luabind::adl::object,1,1,0>, ov1: struct luabind::adl::udm_type<class luabind::adl::object,1,1,0>, type: enum udm::Type, arg0001: number): bool
function udm.compare_numeric_values(ov0, ov1, type) end
...
--- @param type enum udm::Type
--- @return enum udm::Type ret0
function udm.get_underlying_numeric_type(type) end
...
--- @param idx int
--- @param type enum udm::Type
--- @param componentValue struct luabind::adl::udm_type<class luabind::adl::object,1,0,0>
--- @return any ret0
function udm.set_numeric_component(value, idx, type, componentValue) end

--- 
--- @param prop0 udm.LinkedPropertyWrapper
--- @param prop1 udm.LinkedPropertyWrapper
--- @return bool ret0
function udm.is_same_element(prop0, prop1) end
...
--- @param type string
--- @return enum udm::Type ret0
function udm.string_to_type(type) end
...
--- 
function udm.PropertyWrapper:ClearUncompressedMemory() end
...
--- @return udm.LinkedPropertyWrapper ret0
--- @overload fun(arg2: string): udm.LinkedPropertyWrapper
function udm.PropertyWrapper:Get(arg2) end
...
--- 
--- @return class Lua::udm::LuaUdmArrayIterator ret0
...
--- 
function udm.Element:ClearUncompressedMemory() end
...
--- @return udm.LinkedPropertyWrapper ret0
--- @overload fun(arg2: string): udm.LinkedPropertyWrapper
function udm.Element:Get(arg2) end
...
--- 
function udm.Property:ClearUncompressedMemory() end
...
--- 
--- @return udm.LinkedPropertyWrapper ret0
--- @overload fun(arg2: int): udm.LinkedPropertyWrapper
--- @overload fun(arg2: string): udm.LinkedPropertyWrapper
