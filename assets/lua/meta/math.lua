...
--- 
--- @param axis enum pragma::SignedAxis
--- @return math.Vector ret0
--- @overload fun(axis: enum pragma::SignedAxis): math.Vector
function math.axis_to_vector(axis) end
...
--- @param toHigh number
--- @return number ret0
function math.remap(value, fromLow, fromHigh, toLow, toHigh) end
...
--- @return table ret0_1
--- @return table ret0_2
--- @overload fun(radius: int, sigma: number, linear: bool, correction: bool): table, table
--- @overload fun(radius: int, sigma: number, linear: bool, correction: bool): table, table
function math.generate_two_pass_gaussian_blur_coefficients(radius, sigma, linear, correction) end

--- 
--- @param t number
--- @param p0 math.Vector2
--- @param p1 math.Vector2
--- @param p2 math.Vector2
--- @param p3 math.Vector2
--- @return math.Vector2 ret0
function math.calc_bezier_point_fraction(t, p0, p1, p2, p3) end

--- 
--- @param space enum umath::CoordinateSpace
--- @return string ret0
function math.coordinate_space_to_string(space) end
...
function math.calc_four_point_cubic_bezier(p0, p1, p2, p3) end
...
--- @param points table
--- @return table ret0
--- @overload fun(points: table, error: number): table
function math.reduce_curve_points(points) end

--- 
--- @param sourceAxis math.Vector
--- @param targetAxis math.Vector
--- @return math.Quaternion ret0
--- @overload fun(sourceAxis: vector.Vector, targetAxis: vector.Vector): math.Quaternion
function math.calc_rotation_to_axis(sourceAxis, targetAxis) end
...
--- @param axis enum pragma::SignedAxis
--- @return bool ret0
function math.is_negative_axis(axis) end
...
--- @return table ret0
function math.fit_bezier_curve(data, maxError) end
...
--- @param axis enum pragma::SignedAxis
--- @return bool ret0
function math.is_positive_axis(axis) end
...
function math.string_to_coordinate_space(space) end
...
--- @param sourceAxis math.Vector
--- @param targetAxis math.Vector
--- @overload fun(sourceAxis: vector.Vector, targetAxis: vector.Vector): 
function math.Quaternion:AlignToAxis(sourceAxis, targetAxis) end
...
--- 
--- @param b math.Quaternion
--- @return bool ret0
--- @overload fun(b: math.Quaternion, epsilon: number): bool
function math.Quaternion:Equals(b) end
...
--- @return math.Vector ret0
--- @overload fun(axis: enum pragma::SignedAxis): math.Vector
function math.Quaternion:GetAxisVector(axis) end
...
function math.Quaternion:ToMatrix3() end
...
--- @overload fun(arg1: math.ScaledTransform):math.Transform
